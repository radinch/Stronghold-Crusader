...
public class Government {
    ...
    public double getFoodByName(String string){
        if (string.equals("meat")) return foods[0];
        if (string.equals("cheese")) return foods[1];
        if (string.equals("apple")) return foods[2];
        if (string.equals("bread")) return foods[3];
        return 0;
    }
