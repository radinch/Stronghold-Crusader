...
public class OtherBuilding extends Building {
    ...
    public OtherBuilding(Government government, double gold, String name, int hitpoint, Resource resourceRequired, int amountOfResource, int amountOfWorkers, ArrayList<Texture> textures, ArrayList<Cell> occupiedCells, Integer rate, Integer capacity) {
